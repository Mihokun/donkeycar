...
class CreateCar(BaseCommand):
    ...
    def create_car(self, path, template='complete', overwrite=False):
        ...
        controller_template_path = os.path.join(TEMPLATES_PATH, 'remote-controller.py')
        ...
        controller_app_path = os.path.join(path, 'remote-controller.py')   
        ...
        if os.path.exists(car_app_path) and not overwrite:
            ...
            shutil.copyfile(controller_template_path, controller_app_path)
